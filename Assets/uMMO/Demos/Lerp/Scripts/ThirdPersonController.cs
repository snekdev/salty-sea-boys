...
namespace SoftRare.Div {
    [RequireComponent(typeof(CharacterController))]
    public class ThirdPersonController : SoftRare.Net.PlayerAction {
        ...
        void UpdateSmoothedMovementDirection() {
            ...
            if (getUserInput) {
                verticalInput = uMMOInput.GetAxisRaw("Vertical");
                horizontalInput = uMMOInput.GetAxisRaw("Horizontal");
            }
        ...
        void ApplyGravity() {
            // Apply gravity
            if (getUserInput)
                jumpButton = uMMOInput.GetButton("Jump");
        ...
        void Update() {
            ...
            if (getUserInput) {
                if (uMMOInput.GetButtonDown("Jump"))
