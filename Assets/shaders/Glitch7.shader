	...
	SubShader
	{
		...
		//	float	_Percent;
			...
			{ 
				...
				v.vertex.xyz += v.normal * _SinScale *sin( fmod(aaa1, _ModConst));
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				col = lerp(_Color1, _Color2, fmod( .3 *( i.wpos.x + i.wpos.y +  i.wpos.z + _SinScale * sin(_Time.y)), 1));
